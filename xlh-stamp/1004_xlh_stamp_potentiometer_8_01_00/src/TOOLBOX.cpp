...
void visu_loop(void)
{
    ...
    sprite.printf("POTI-8\r\n");

    sprite.printf("12 %03d %03d\r\n", can_open.out.abyPoti[0], can_open.out.abyPoti[1]);
    sprite.printf("34 %03d %03d\r\n", can_open.out.abyPoti[2], can_open.out.abyPoti[3]);
    sprite.printf("56 %03d %03d\r\n", can_open.out.abyPoti[4], can_open.out.abyPoti[5]);
    sprite.printf("78 %03d %03d\r\n", can_open.out.abyPoti[6], can_open.out.abyPoti[7]);
