...
void CHAIN2::cyclic(void)
{
    ...
    else
    {
        ...
        value8Bit0 += this->out.keyButtonStatus[9];
        ...
        this->out.value16Bit[0] = this->out.angleValue[0];
        this->out.value16Bit[1] = this->out.angleValue[2];
        this->out.value16Bit[2] = this->out.angleValue[4];
        portEXIT_CRITICAL(&chain2Mux);
    }
}
