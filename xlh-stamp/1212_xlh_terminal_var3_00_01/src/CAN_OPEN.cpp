...
void CAN_OPEN::rx_pdo_1(twai_message_t *msg_rx)
{
  ...
  {
    memcpy(this->in.abyRxData1, msg_rx->data, 6);

    brightness = this->in.abyRxData1[5];
    ...
    chain2.in.rgbLed[0] = (this->in.abyRxData1[2] & 0b00110000) >> 4;
    chain2.in.rgbLed[1] = (this->in.abyRxData1[2] & 0b11000000) >> 6;
    
    chain2.in.rgbLed[2] = (this->in.abyRxData1[3] & 0b00000011);
    chain2.in.rgbLed[3] = (this->in.abyRxData1[3] & 0b00001100) >> 2;
    chain2.in.rgbLed[4] = (this->in.abyRxData1[3] & 0b00110000) >> 4;
    chain2.in.rgbLed[5] = (this->in.abyRxData1[3] & 0b11000000) >> 6;

    chain2.in.rgbLed[6] = (this->in.abyRxData1[4] & 0b00000011);
    chain2.in.rgbLed[7] = (this->in.abyRxData1[4] & 0b00001100) >> 2;
    chain2.in.rgbLed[8] = (this->in.abyRxData1[4] & 0b00110000) >> 4;
    chain2.in.rgbLed[9] = (this->in.abyRxData1[4] & 0b11000000) >> 6;
...
void CAN_OPEN::tx_pdo_1(void)
{
  ...
  portENTER_CRITICAL_ISR(&chain2Mux);
    this->out.abyTxData1[2] = chain2.out.value8Bit[0];
  portEXIT_CRITICAL_ISR(&chain2Mux);
...
void CAN_OPEN::tx_pdo_2(void)
{
  ...
  portENTER_CRITICAL_ISR(&chain1Mux);
    ...
    this->out.abyTxData2[0] = canMsgDataIntToByte.abyValue[0];
    this->out.abyTxData2[1] = canMsgDataIntToByte.abyValue[1];
  portEXIT_CRITICAL_ISR(&chain1Mux);
  ...
  portENTER_CRITICAL_ISR(&chain2Mux);
    ...
    canMsgDataIntToByte.iValue = chain2.out.value16Bit[1];
    this->out.abyTxData2[4] = canMsgDataIntToByte.abyValue[0];
    this->out.abyTxData2[5] = canMsgDataIntToByte.abyValue[1];
    canMsgDataIntToByte.iValue = chain2.out.value16Bit[2];
    this->out.abyTxData2[6] = canMsgDataIntToByte.abyValue[0];
    this->out.abyTxData2[7] = canMsgDataIntToByte.abyValue[1];
  portEXIT_CRITICAL_ISR(&chain2Mux);
