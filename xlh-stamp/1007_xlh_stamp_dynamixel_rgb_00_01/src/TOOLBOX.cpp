...
void visu_loop(void)
{
    ...
    sprite.printf("DXL - RGB\r\n");

    sprite.printf("POS1 %d\r\n", can_open.out.uiDxl1Position);
    sprite.printf("CUR1 %d\r\n", can_open.out.iDxl1Current);
    sprite.printf("POS2 %d\r\n", can_open.out.uiDxl2Position);
    sprite.printf("CUR2 %d\r\n", can_open.out.iDxl2Current);
