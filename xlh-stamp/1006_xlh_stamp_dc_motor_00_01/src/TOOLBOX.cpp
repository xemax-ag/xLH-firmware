...
void visu_loop(void)
{
    ...
    sprite.printf("DC-MOTOR\r\n");

    sprite.printf("CTL " PRINTF_BINARY_PATTERN_INT8 "\r\n", PRINTF_BYTE_TO_BINARY_INT8(can_open.in.byControl));
    sprite.printf("DC  %d\r\n", can_open.in.uiDutyCycle);
    sprite.printf("POS %d\r\n", can_open.out.diPosition);
    sprite.printf("CUR %d\r\n", can_open.out.uiCurrent);
