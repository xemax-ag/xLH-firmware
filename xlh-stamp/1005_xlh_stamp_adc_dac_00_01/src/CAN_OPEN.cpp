...
void CAN_OPEN::tx_pdo_1(void)
{
  ...
  if ((this->out.iAdc <= (this->out_old.iAdc - PDO_TX_1_ADC_HYSTERESIS)) ||
      (this->out.iAdc >= (this->out_old.iAdc + PDO_TX_1_ADC_HYSTERESIS)))
