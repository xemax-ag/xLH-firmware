...
void CAN_OPEN::tx_pdo_3(void)
{
  ...
  if (this->out.iYaw != this->out_old.iYaw)
    this->pdo_tx_3_send_msg = 1;
  if (this->out.iPitch != this->out_old.iPitch)
    this->pdo_tx_3_send_msg = 1;
  if (this->out.iRoll != this->out_old.iRoll)
    this->pdo_tx_3_send_msg = 1;
  ...
  if ((this->node_guard_state == NODE_GUARD_STATE_OPERATIONAL) && (this->pdo_tx_3_send_msg == 1))
  {
    ...
    canMsgDataIntToByte.uiValue = this->out.iYaw;
    tx_frame.data[0] = canMsgDataIntToByte.abyValue[0];
    tx_frame.data[1] = canMsgDataIntToByte.abyValue[1];
    canMsgDataIntToByte.uiValue = this->out.iPitch;
    tx_frame.data[2] = canMsgDataIntToByte.abyValue[0];
    tx_frame.data[3] = canMsgDataIntToByte.abyValue[1];
    canMsgDataIntToByte.uiValue = this->out.iRoll;
    tx_frame.data[4] = canMsgDataIntToByte.abyValue[0];
    tx_frame.data[5] = canMsgDataIntToByte.abyValue[1];
    ...
    this->out_old.iYaw = this->out.iYaw;
    this->out_old.iPitch = this->out.iPitch;
    this->out_old.iRoll = this->out.iRoll;
  }
}
